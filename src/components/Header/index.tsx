      ...
      <div className={style.container}>
        ...
        <div className={style.bar}>
          <ul className={style.list}>
            <li>
              <NavLink to="/" style={{ color: checkName == '/' ? '#00b9f1' : 'black' }}>首页</NavLink>
            </li>
            <li >
              <Dropdown overlay={menuOne} placement={'bottom'} className={style.drop}>
                <a onClick={(e) => e.preventDefault()}>
                  <Space style={{ color: (checkName == '/finance' || checkName == '/solution') ? '#00b9f1' : 'black' }}>产品与服务</Space>
                </a>
              </Dropdown>
            </li>
            <li>
            ...
            <li>
              <NavLink to="/concat" style={{ color: (checkName == '/concat') ? '#00b9f1' : 'black' }}>联系我们</NavLink>
            </li>
          </ul>
        </div>
